...
module.exports = async function starMessage(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/messages/{MessageID}/star";
  ...
  if (method !== 'GET'){
    ...
    const bodyObj = {};
    if (args.hasOwnProperty('starred')) bodyObj['starred'] = args['starred'];
