...
module.exports = async function sendMessageDocument(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/messages/document";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    if (args.hasOwnProperty('filename')) bodyObj['filename'] = args['filename'];
