...
module.exports = async function unsubscribeNewsletterInvite(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/newsletters/invite/{NewsletterInviteCode}/subscription";
  for (const p of [{"name":"NewsletterInviteCode","type":"string","required":true,"description":"Newsletter Invite Code"}]){
