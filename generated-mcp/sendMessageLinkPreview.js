...
module.exports = async function sendMessageLinkPreview(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/messages/link_preview";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    if (args.hasOwnProperty('canonical')) bodyObj['canonical'] = args['canonical'];
