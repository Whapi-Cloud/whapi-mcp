...
module.exports = async function sendMessageContact(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/messages/contact";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    if (args.hasOwnProperty('vcard')) bodyObj['vcard'] = args['vcard'];
