...
module.exports = async function reactToMessage(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/messages/{MessageID}/reaction";
  for (const p of [{"name":"MessageID","type":"string","required":true,"description":"Message ID"}]){
  ...
  if (method !== 'GET'){
    ...
    const bodyObj = {};
    if (args.hasOwnProperty('emoji')) bodyObj['emoji'] = args['emoji'];
