...
module.exports = async function sendMessageGif(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/messages/gif";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    if (args.hasOwnProperty('autoplay')) bodyObj['autoplay'] = args['autoplay'];
