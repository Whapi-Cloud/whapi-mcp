...
module.exports = async function sendMessageCarousel(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/messages/carousel";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    if (args.hasOwnProperty('cards')) bodyObj['cards'] = args['cards'];
