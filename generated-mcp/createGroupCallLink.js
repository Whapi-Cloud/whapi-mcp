...
module.exports = async function createGroupCallLink(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/calls/group_link";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    const bodyObj = {};
    if (args.hasOwnProperty('start_time')) bodyObj['start_time'] = args['start_time'];
