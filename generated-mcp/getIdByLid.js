...
module.exports = async function getIdByLid(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/contacts/ids/{ContactLID}";
  for (const p of [{"name":"ContactLID","type":"string","required":true,"description":"Contact LID"}]){
