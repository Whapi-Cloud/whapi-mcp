...
module.exports = async function sendMessageVoice(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/messages/voice";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    if (args.hasOwnProperty('recording_time')) bodyObj['recording_time'] = args['recording_time'];
    if (args.hasOwnProperty('waveform')) bodyObj['waveform'] = args['waveform'];
