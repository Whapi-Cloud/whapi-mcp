...
module.exports = async function deleteMedia(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/media/{MediaID}";
  for (const p of [{"name":"MediaID","type":"string","required":true,"description":"Media ID"}]){
