...
module.exports = async function createGroupInCommunity(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/communities/{CommunityID}";
  ...
  if (method !== 'GET'){
    ...
    const bodyObj = {};
    if (args.hasOwnProperty('subject')) bodyObj['subject'] = args['subject'];
    if (args.hasOwnProperty('isHidden')) bodyObj['isHidden'] = args['isHidden'];
