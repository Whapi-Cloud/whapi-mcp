...
module.exports = async function loginUserPasskeyChrome(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/users/login/passkey/chrome";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    if (args.hasOwnProperty('timeout_ms')) bodyObj['timeout_ms'] = args['timeout_ms'];
