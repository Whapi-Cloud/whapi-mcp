...
module.exports = async function createCollection(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/business/collections";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    if (args.hasOwnProperty('products')) bodyObj['products'] = args['products'];
