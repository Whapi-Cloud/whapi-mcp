...
module.exports = async function joinInCommunityGroup(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/communities/{CommunityID}/{GroupID}/join";
  for (const p of [{"name":"CommunityID","type":"string","required":true,"description":"Community ID"},{"name":"GroupID","type":"string","required":true,"description":"Group ID"}]){
