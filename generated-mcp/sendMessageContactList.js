...
module.exports = async function sendMessageContactList(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/messages/contact_list";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    if (args.hasOwnProperty('list')) bodyObj['list'] = args['list'];
