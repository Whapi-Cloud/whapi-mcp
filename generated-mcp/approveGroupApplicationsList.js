...
module.exports = async function approveGroupApplicationsList(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/groups/{GroupID}/applications";
  ...
  if (method !== 'GET'){
    ...
    const bodyObj = {};
    if (args.hasOwnProperty('application')) bodyObj['application'] = args['application'];
