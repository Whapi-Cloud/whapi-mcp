...
module.exports = async function createLabel(args, env = process.env) {
  ...
  if (method !== 'GET'){
    ...
    const bodyObj = {};
    if (args.hasOwnProperty('id')) bodyObj['id'] = args['id'];
    if (args.hasOwnProperty('name')) bodyObj['name'] = args['name'];
    if (args.hasOwnProperty('color')) bodyObj['color'] = args['color'];
