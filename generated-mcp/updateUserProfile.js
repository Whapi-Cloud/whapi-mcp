...
module.exports = async function updateUserProfile(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/users/profile";
  for (const p of []){
  ...
  if (method !== 'GET'){
    ...
    if (args.hasOwnProperty('about')) bodyObj['about'] = args['about'];
    if (args.hasOwnProperty('icon')) bodyObj['icon'] = args['icon'];
