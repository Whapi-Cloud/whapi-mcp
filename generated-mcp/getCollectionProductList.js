...
module.exports = async function getCollectionProductList(args, env = process.env) {
  // Build path with path params
  let pathTmpl = "/business/collections/{CollectionID}/products";
  ...
  // Query string
  const queryPairs = [];
  for (const q of [{"name":"products_count","type":"number","required":false,"default":10,"description":"Count of products in collection to return"}]){
    const v = args[q.name];
